 ...
 */
@interface NSString (SKNSStringAdditions)


/**
 * Return a formatted string with time format:ddMMMYY_hhmmssa
 */
+ (NSString *)dateString;
...
/**
 * Parses a NSString, return the substring between [pattern] and [/pattern].
 */
- (NSString *)parseWithPattern:(NSString *)pattern;

/**
 * Delete the string between [pattern] and [/pattern].
 */
